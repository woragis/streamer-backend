...
CREATE TABLE IF NOT EXISTS lc_runtime (
	...
	whiteboard JSONB NOT NULL DEFAULT '{}',
...
-- +goose Down
DROP TABLE IF EXISTS core_bot_rules;
DROP TABLE IF EXISTS core_stream_events;
DROP TABLE IF EXISTS core_messages;
DROP TABLE IF EXISTS core_users;
DROP TABLE IF EXISTS cal_skill_practice_logs;
DROP TABLE IF EXISTS cal_skill_acquisitions;
DROP TABLE IF EXISTS cal_movement_proficiencies;
DROP TABLE IF EXISTS cal_movements;
DROP TABLE IF EXISTS cal_movement_categories;
DROP TABLE IF EXISTS lc_problem_topics;
DROP TABLE IF EXISTS lc_topic_tags;
DROP TABLE IF EXISTS lc_problem_attempts;
DROP TABLE IF EXISTS lc_problems;
DROP TABLE IF EXISTS lc_plan_items;
DROP TABLE IF EXISTS lc_runtime;
DROP TABLE IF EXISTS live_sessions;
DROP TABLE IF EXISTS cal_sets;
DROP TABLE IF EXISTS cal_workout_exercises;
DROP TABLE IF EXISTS cal_workouts;
DROP TABLE IF EXISTS cal_runtime;
